...
{
    public class AgencyCreatePage : BasePage
    {
        private IWebElement _ddlMasterAgency => FindElementById("ctl00_Content_ddlMasterAgency");
        private IWebElement _txtMasterAgency => FindElementById("ctl00_Content_txtMasterAgency");
        private IWebElement _txtName => FindElementById("ctl00_Content_txtAgencyName");
        ...
        private IWebElement _flLogo => FindElementById("ctl00_Content_flLogoUpload");
        private IWebElement _chkIOEnabled => FindElementById("ctl00_Content_chkAllowIO");
        private IWebElement _ddlBillingSource => FindElementById("ctl00_Content_ddlBillingSource");
        private IWebElement _rdoBillingExportTypeBCC924 => FindElementById("ctl00_Content_rdoBillingApp_0");
        private IWebElement _rdoBillingExportTypeBCC925 => FindElementById("ctl00_Content_rdoBillingApp_1");
        private IWebElement _rdoBillingExportTypeDDSMediaExplorer => FindElementById("ctl00_Content_rdoBillingApp_2");
        private IWebElement _rdoBillingExportTypeDDSUK => FindElementById("ctl00_Content_rdoBillingApp_3");
        private IWebElement _rdoBillingExportTypeDDSUS => FindElementById("ctl00_Content_rdoBillingApp_4");
        private IWebElement _rdoBillingExportTypePegasus => FindElementById("ctl00_Content_rdoBillingApp_5");
        private IWebElement _rdoBillingExportTypeOther => FindElementById("ctl00_Content_rdoBillingApp_6");
        private IWebElement _ddlLanguage => FindElementById("ctl00_Content_ddlCulture");
        private IWebElement _ddlTimeZone => FindElementById("ctl00_Content_ddlTimeZone");
        private IWebElement _chkEnableAgencyOverride => FindElementById("ctl00_Content_chkAllowUserCulture");
        ...
        private IWebElement _txtContactPhone => FindElementById("ctl00_Content_txtContactPhone");
        private IWebElement _chkUniquePlannerBuyer => FindElementById("ctl00_Content_chkUniquePlannerBuyer");
        private IWebElement _ddlAuthenticationMethod => FindElementById("ctl00_Content_ddlAuthTypes");
        ...
        public AgencyCreatePage(IWebDriver driver, FeatureContext featureContext) : base(driver, featureContext)
        {
        }

        public void CreateAgency(AgencyData agencyData)
        {
            EnsureMandatoryValuesAreProvided(agencyData);

            if (!string.IsNullOrWhiteSpace(agencyData.MasterAgency))
            {
                try
                {
                    SelectWebformDropdownValueByText(_ddlMasterAgency, agencyData.MasterAgency);
                }
                catch (NoSuchElementException)
                {
                    ClearInputAndTypeValue(_txtMasterAgency, agencyData.MasterAgency);
                }
            }
            ...
            SetWebformCheckBoxState(_chkUniquePlannerBuyer, agencyData.UniquePlannerBuyer);
